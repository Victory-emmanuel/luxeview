        ...
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="font-body text-lg text-text-secondary/80 leading-relaxed">
              With over two decades of experience in ultra-luxury real estate, I
              specialize in connecting discerning clients with exceptional
              properties. My commitment to white-glove service and intimate
              knowledge of the most exclusive markets ensures a seamless journey
              to your dream home.
            </p>
